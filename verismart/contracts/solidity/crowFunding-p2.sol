...
contract Escrow {
  ...
  function deposit(address p) onlyOwner public checkRefundWithdraw   payable {
  ...
  function withdraw() public checkRefundWithdraw   {
  ...
  function claimRefund(address payable p) public checkRefundWithdraw   {
  ...
  function close() onlyOwner public checkRefundWithdraw   {
    state = State.SUCCESS;
    transaction = Tx.Close;
  }
  function refund() onlyOwner public checkRefundWithdraw   {
    state = State.REFUND;
