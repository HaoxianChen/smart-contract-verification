contract BrickBlockToken {
  ...
  function upgrade(address p) public  checkEvacuateAfterUpgrade  {
  ...
  function finalizeTokenSale() public    checkEvacuateAfterUpgrade{
  ...
  function approve(address s,uint n) public    checkEvacuateAfterUpgrade{
  ...
  function decreaseApproval(address s,uint a) public    checkEvacuateAfterUpgrade{
  ...
  function distributeTokens(address p,uint v) public    checkEvacuateAfterUpgrade{
  ...
  function unpause() public    checkEvacuateAfterUpgrade{
  ...
  function evacuate(address p) public    checkEvacuateAfterUpgrade{
  ...
  function increaseApproval(address s,uint a) public    checkEvacuateAfterUpgrade{
  ...
  function transferFrom(address from,address to,uint a) public    checkEvacuateAfterUpgrade{
  ...
  function changeFountainContractAddress(address p) public    checkEvacuateAfterUpgrade{
  ...
  function transfer(address to,uint a) public    checkEvacuateAfterUpgrade{
