contract BrickBlockToken {
  ...
  function upgrade(address p) public checkDeadAfterPause      {
  ...
  function finalizeTokenSale() public  checkDeadAfterPause     {
  ...
  function decreaseApproval(address s,uint a) public  checkDeadAfterPause     {
  ...
  function distributeTokens(address p,uint v) public  checkDeadAfterPause     {
  ...
  function unpause() public  checkDeadAfterPause     {
  ...
  function evacuate(address p) public  checkDeadAfterPause     {
  ...
  function transferFrom(address from,address to,uint a) public  checkDeadAfterPause     {
  ...
  function approve(address s,uint n) public  checkDeadAfterPause     {
  ...
  function increaseApproval(address s,uint a) public  checkDeadAfterPause     {
  ...
  function changeFountainContractAddress(address p) public  checkDeadAfterPause     {
  ...
  function transfer(address to,uint a) public  checkDeadAfterPause     {
