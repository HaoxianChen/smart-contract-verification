contract BrickBlockToken {
  ...
  function upgrade(address p) public checkTransferAfterEndSale      {
  ...
  function finalizeTokenSale() public  checkTransferAfterEndSale     {
  ...
  function decreaseApproval(address s,uint a) public  checkTransferAfterEndSale     {
  ...
  function distributeTokens(address p,uint v) public  checkTransferAfterEndSale     {
  ...
  function unpause() public  checkTransferAfterEndSale     {
  ...
  function evacuate(address p) public  checkTransferAfterEndSale     {
  ...
  function transferFrom(address from,address to,uint a) public  checkTransferAfterEndSale     {
  ...
  function approve(address s,uint n) public  checkTransferAfterEndSale     {
  ...
  function increaseApproval(address s,uint a) public  checkTransferAfterEndSale     {
  ...
  function changeFountainContractAddress(address p) public  checkTransferAfterEndSale     {
  ...
  function transfer(address to,uint a) public  checkTransferAfterEndSale     {
